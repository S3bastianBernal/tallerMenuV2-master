...
<body>
    ...
    <form action="menu.php" method="post">
        <h3>ingresar opcion del menu</h3>
        <ul>
            <li>----MENU----</li>
            <li>1. Lectura de datos</li>
            <li>2. Crear Array</li>
            <li>3. Mostrar Array</li>
            <li>4. Eliminar primer elemento del Array</li>
            <li>5. Eliminar el ultimo elemento del Array</li>
            <li>6. Eliminar cualquier elemento del Array</li>
            <li>7. Agregar elemento al comienzo del Array</li>
            <li>8. Agregar elemento al final del Array</li>
            <li>9. Crear Array con objetos </li>
            <li>10. Iterar Array con FOR </li>
            <li>11. Iterar Array con ForEach</li>
            <li>12. Iterar objetos con Map y crear copia</li>
            <li>13. proceso personal</li>
            <li>0. Salir</li>
        </ul>
